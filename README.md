...
### [第1章: Vim解决问题的方式](./第1章:Vim解决问题的方式.md)
...
### [第2章: 普通模式](./第2章:普通模式.md) 

```
w             正向移动到下一单词的开头
W             正向移动到下一单词的开头(跳过符号)
b             反向移动到当前单词/上一单词的开头
B             反向移动到当前单词/上一单词的开头(跳过符号)
e             正向移动到当前单词/下一单词的结尾
...
### [第8章: 用动作命令在文档中移动](./第8章:用动作命令在文档中移动.md)
...
### [第12章: 按模式匹配及按原义匹配](./第12章:按模式匹配及按原义匹配.md)
...
### [第15章: global命令](./第15章:global命令.md)
...
### [第16章: 通过ctags建立索引，并用其浏览源代码](./第16章:通过ctags建立索引，并用其浏览源代码.md)
...
```
### [第17章: 编译代码，并通过Quickfix列表浏览错误信息](./第17章:编译代码，并通过Quickfix列表浏览错误信息.md)

> vim调用外部编译器，从而省去了离开编辑器的麻烦

### [第18章: 通过grep、vimgrep以及其他工具对整个工程进行查找](./第18章:通过grep、vimgrep以及其他工具对整个工程进行查找.md)

> 不必离开Vim也能调用grep

### [第19章：自动补全](./第19章:自动补全.md)
...
### [第20章: 利用Vim的拼写检查器，查找并更正拼写错误](./第20章:利用Vim的拼写检查器，查找并更正拼写错误.md)
